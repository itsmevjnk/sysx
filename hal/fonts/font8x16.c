...
/* The 8x16 font was sourced from https://github.com/susam/pcface - for licensing see https://github.com/susam/pcface/blob/main/LICENSE.md */
static const uint8_t font8x16_bitmap[256][16] = {
...
void font8x16_draw(fbuf_font_t* font, size_t x, size_t y, char c, uint32_t fg, uint32_t bg, bool transparent) {
    ...
    for(size_t row = 0; row < 16; row++) {
        ...
        for(size_t col = 0; col < 8; col++) {
            if(rbm & 0x80) fbuf_putpixel(x + col, y + row, 1, fg);
            else if(!transparent) fbuf_putpixel(x + col, y + row, 1, bg);
            rbm <<= 1;
        }
    }
}

fbuf_font_t font8x16 = {
    8,
    16,
    NULL,
    &font8x16_draw
