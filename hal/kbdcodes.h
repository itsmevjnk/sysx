#ifndef HAL_KBDCODES_H
#define HAL_KBDCODES_H

#include <stddef.h>
#include <stdint.h>

/* keyboard scancodes - adapted from the HID scan code list: https://gist.github.com/MightyPork/6da26e382a7ad91b5496ee55fdc73db2 */
